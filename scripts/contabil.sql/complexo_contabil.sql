...
CREATE TABLE contabil.plano_contas(
	...
	CONSTRAINT pk_plano_contas PRIMARY KEY(id_plano_contas)
);
...
CREATE TABLE contabil.lancamentos(
	...
	CONSTRAINT fk_conta_debito FOREIGN KEY(conta_debito_id) REFERENCES contabil.plano_contas(id_plano_contas),
	CONSTRAINT fk_conta_credito FOREIGN KEY(conta_credito_id) REFERENCES contabil.plano_contas(id_plano_contas)
);